...
from ..app import db, socketio  # CHANGED: import db, socketio from app
from ..app.models import Account, Trade, Payout  # CHANGED: add Payout if used here
from ..app.services.trade_service import execute_trade, request_payout  # CHANGED: clarify the services path
...
def set_trade_copier(data):
    from ..app.services.trade_service import set_trade_copier
